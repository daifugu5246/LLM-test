...
'''
instr1 = '''จงเขียนบทวิเคราะห์หุ้นรายตัวจากข้อมูลและตัวอย่างต่อไปนี้ โดยไม่มีหัวข้ออื่นๆนอกเหนือจากการวิเคราะห์
```
ตัวอย่าง:
Input ชื่อหุ้น:
PTT
...
Output:
'''
llama_prompt = f"<s>[INST] <<SYS>>\nคุณคือนักวิเคราะห์หุ้นไทยมืออาชีพ ที่มีความสามารถในการวิเคราะห์หุ้นรายตัว และต้องเขียนบทวิเคราะห์หุ้น เพื่อนำเสนองานวิจัยออกไปสู่สาธารณะเป็นภาษาไทย<</SYS>>\n\n{instr0} [/INST]"
